...
const Upload = () => {
  ...
  return (
    ...
    >
        {/* Title */}
        <h1 className='text-center text-2xl md:text-3xl lg-text-4xl mt-10 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-6 md:py-16'>
